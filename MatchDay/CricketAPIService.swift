...
public struct CricketAPIService {
    var fetchCurrentMatches: () async throws -> [Match]
}
...
//Dependency
extension CricketAPIService: DependencyKey {
    public static var testValue: CricketAPIService {
    ...
    public static var liveValue: CricketAPIService {
        return CricketAPIService {
...
public extension DependencyValues {
    var cricketAPIService: CricketAPIService {
        get {
            self[CricketAPIService.self]
        } set {
            self[CricketAPIService.self] = newValue
        }
    }
}
